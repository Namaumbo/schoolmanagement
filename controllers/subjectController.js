...
exports.addSubject = async (req, res, next) => {
    ...
    try {
        ...
        const subject = await  require("../models/subjects.js").create({ 
         subjectId,
        subjectName,
        category, 
        creditHours, 
...
exports.deleteASubject = (req,res,next)=>{
    ...
    const deleteSubject = require('../models/subjects.js').destroy({where:{subjectId}})

    deleteSubject.then(response =>{
